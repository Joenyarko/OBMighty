...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('payments', function (Blueprint $table) {
            ...
            $table->index(['recorded_by', 'payment_date'], 'idx_payments_worker_date');
        ...
        Schema::table('stock_items', function (Blueprint $table) {
            $table->index(['company_id', 'quantity'], 'idx_stock_company_quantity');
        });

        // Indexes for ledger entries
        Schema::table('ledger_entries', function (Blueprint $table) {
            $table->index(['company_id', 'date'], 'idx_ledger_company_date');
        ...
        Schema::table('payments', function (Blueprint $table) {
            if (!Schema::hasTable('payments') || !collect(\DB::select(\DB::raw("SHOW INDEXES FROM payments WHERE Key_name = 'idx_payments_full_dashboard'")))->pluck('Key_name')->contains('idx_payments_full_dashboard')) {
                // Index won't be created again if exists
            }
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('stock_items', function (Blueprint $table) {
            $table->dropIndex('idx_stock_company_quantity');
        });
